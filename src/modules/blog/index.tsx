...
import { FaRegTimesCircle, FaCommentAlt } from "react-icons/fa";
import PricingPlan from "@/components/pricing-plans";
import BlogList from "./list";
import Pricing from "../xlox-site/core/pricing";
  ...
  return (
    <>
      <div className="max-w-screen-xl mx-auto p-5 sm:p-10 md:p-16 relative">
        <div
          className={`bg-[url("https://api.time.com/wp-content/uploads/2020/07/never-trumpers-2020-election-01.jpg?quality=85&amp;w=1201&amp;h=676&amp;crop=1")] min-h-[500px] bg-cover bg-center text-center overflow-hidden`}
